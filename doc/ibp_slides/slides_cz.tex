...
\begin{frame}
  ...
  \begin{columns}
    ...
    \column{0.4\textwidth}
    \centering\includegraphics[width=1\textwidth]{img/futoshiki.png}
  \end{columns}
  \vspace{1.5em}
  \centering\includegraphics[width=1\textwidth]{img/1d-futoshiki.png}
\end{frame}
...
% implementovaných algoritmů pro automatické řešení mřížky.
\begin{frame}
