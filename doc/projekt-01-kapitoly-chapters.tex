...
o~velikosti 4x4, přičemž může být i~větší. Pro úspěšné vyřešení je třeba každé
pole v~mřížce vyplnit číslem od 1 do velikosti mřížky. Dále musí platit
pravidlo, že se v~každém řádku a~sloupci čísla nesmí opakovat. Kromě toho jsou
...
zatímco nerovnosti se již nemění a~nepřidávají se žádné nové.
...
číslo z~rozsahu pravidla nesplňuje, algoritmus se vrátí na předchozí pole
a~znovu zkouší jiná čísla. Tento proces se opakuje, dokud není nalezeno validní
...
Algoritmus poté na základě zvolené strategie (heuristiky) vybere jedno z polí
k~vyplnění. Do tohoto pole je dosazena hodnota z~jeho domény, načež jsou
upraveny domény ostatních polí. Z~těchto domén se vyloučí hodnoty, které by
v~kombinaci s~dosazenou hodnotou porušily pravidla hry.
...
pole. Pro vygenerování domén polí nejdříve vygeneruji domény všech řádků
a~sloupců, na základě kterých vytvořím doménu pro každé pole. Konkrétně je
provedeno sjednocení domény konkrétního řádku a~sloupce. Dále projdu všechny
...
pole. Naopak z~domény pole, které má být větší, odstraním hodnoty menší nebo
rovné minimální hodnotě sousedícího pole.

Po vygenerování domén počíná fáze zapisování hodnot. Pro zvolení hracího pole
používám heuristiku nejvíce omezená proměnná, což znamená, že vybírám pole
s~nejmenší doménou. Z~domény tohoto pole poté postupně vybírám hodnoty, které
jsou do pole dosazovány. Po dosazení hodnoty upravím domény všech ovlivněných
polí tak, aby stále platila pravidla. Ovlivněná pole jsou taková pole, která
se nachází ve stejném řádku či sloupci a~nebo jsou v~nerovnosti s~polem, do
kterého se zapisuje. Tento postup se opakuje, dokud není nalezeno řešení nebo
dokud nejsou vyzkoušeny všechny možné cesty.
