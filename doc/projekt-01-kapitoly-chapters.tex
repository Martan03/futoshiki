...
implementace, kdy v~jedné variantě jsou domény uloženy jako hašovací množiny
a~v druhé jako bitmapy. Tento algoritmus vylepšuje základní princip
Backtrackingu tím, že předběžně kontroluje možné hodnoty, což vede ke snížení
počtu zkoušených kombinací.
...
Některé algoritmy využívající technik look-ahead mohout využívat
...
větších/menších jak dané hodnota. Tyto operace jsou velmi často využiti
...
inicializovat vytvořením domény obsahujících všechny hodnoty, jelikož
algoritmus Forward Checking již počítá s tím, že kolidující hodnoty jsou již
odstraněny. Proto je na počátku třeba domény nejen inicializovat, aby
