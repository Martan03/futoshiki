...
Checking a~Arc Consistency \#3. Look-ahead techniky se snaží zmenšit počet
zkoušených kombinací tím, že se pokusí předvídat účinky jednotlivých kroků
při hledání řešení.
...
dvojcestné konečné automaty. Na konci této kapitoly je popsán skákající automat
a čtyřcestný konečný automat, který využívá princip dvojcestného automatu pro
řešení problému s~dvojrozměrnou vstupní páskou.
...
směrech (nahoru, dolů, doleva a doprava), tak i~skoky.
...
obsažena pravidla pro Arc Consistency \#3. Ten je velmi podobný, jako Forward
Checking, z~toho důvodu jsou popsána pouze rozlišná pravidla.
