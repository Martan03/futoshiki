...
vytvoření specifického automatu na řešení hry Futoshiki.
...
Jsou zde popsány deterministické a nedeterministické konečné automaty,
dvojcestný konečný automat, který nám ukáže princip pohybu na vstupní pásce,
který se využívá i~u~vícedimenzionálních automatů. Nakonec bude popsán také
...
čtyřech směrech, stejně jako čtyřcestný automat, ale také skoky. Tento automat
je následně využit pro řešení mřížky Futoshiki.

Následující kapitola obsahuje pravidla pro automat samotný. Jsou zde definovány
základní symboly automatu, které jsou využity v~pravidlech. Následují pravidla
automatu pro řešení mřížky Futoshiki pomocí algoritmu Backtracking a~pravidla
pro řešení pomocí algoritmu Forward Checking. Pravidla pro algoritmus Arc
Consistency \#3 jsou velmi podobná jako pro Forward Checking, z~toho důvodu
jsou popsána pouze rozdílná pravidla. To je z~důvodu podobnosti algoritmů,
kde Arc Consistency \#3 má pouze více striktní úpravy domén.
...
jednodušší tvorbu terminálových uživatelských rozhraní.
