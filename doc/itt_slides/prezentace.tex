...
%---------------------------------------------------------------------------
\projectinfo{
  date={27. 01. 2025}, % Datum - je vhodné vepsat datum obhajoby (natvrdo), ne datum kompilace slajdů / Date - it is advisable to write the date of the defense (hard), not the date of the slide compilation
  title={Řešení futoshiki pomocí automatů}, % Název prezentace / Presentation title (The whole title of the presented work suitably divided into lines that are optically balanced)
  title.footer={Řešení futoshiki pomocí automatů}, % Název prezentace - text zobrazovaný vedle čísla slajdu / Presentation title - displayed next to the slide number (The full title of the presented work, it may be suitably abbreviated to fit the footer)
  ...
  supervisor.name={Alexander}, % Jméno vedoucího / Supervisor name
  supervisor.surname={Meduna}, % Příjmení vedoucího / Supervisor surname
  supervisor.title.first={prof. RNDr.}, % Tituly před jménem / Supervisor's titles before the name
  supervisor.title.last={CSc.} % Tituly za jménem / Supervisor's titles after the name
}
