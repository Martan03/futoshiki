...
\begin{frame}
  ...
  \center\includegraphics[width=\textwidth]{img/goal.png}
\end{frame}
...
\begin{frame}
  ...
  \centering\includegraphics[width=0.4\textwidth]{img/futoshiki.png}
  \begin{enumerate}
...
\begin{frame}
  ...
  \column{0.7\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{img/benchmark.png}
  \end{columns}
\end{frame}
...
\begin{frame}
  ...
  \column{0.7\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{img/left.png}
  \end{columns}
\end{frame}
...
\begin{frame}
  ...
  \center\includegraphics[width=0.7\textwidth]{img/futoshiki-large.png}
  % \makebox[\textwidth]{
    % \begin{tikzpicture}
    %   \node (screenshot)
...
\appendix{}
\begin{frame}
  \frametitle{Zdroje prezentace}
  \begin{itemize}
    \item \href{https://www.flaticon.com/free-icon/intelligence_14510304?related_id=14510304}{Ikona automatu (flaticon.com)}
    \item \href{https://www.flaticon.com/free-icon/programming_6062646?related_id=6062646}{Ikona počítače (flaticon.com)}
    \item \href{https://www.flaticon.com/free-icon/search_3281188?related_id=3281188}{Ikona testů (flaticon.com)}
  \end{itemize}
  \bigskip
